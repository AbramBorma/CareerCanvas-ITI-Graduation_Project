// src/components/SupervisorApprovalMessage.js
import React from 'react';

const SupervisorApprovalMessage = () => {
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        <h2 style={styles.title}>Waiting for Admin Approval</h2>
        <p style={styles.message}>
          Your account is currently pending approval by the admin. Please wait for your admin to approve your access.
        </p>
...
export default SupervisorApprovalMessage;
